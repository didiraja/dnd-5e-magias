...
export const skills = [
  ...
  },
  {
    id: ID(),
    type: "jutsu",
    name: "Compreensão dos Ancestrais",
    stats: [
      {
        name: "Tempo de Execução",
        desc: "Ação Padrão",
    ...
    desc:
      "Você entende qualquer coisa falada ou escrita, mas precisa tocar a criatura com quem esteja falando ou a inscrição que quer entender",
    bonus: [
      {
        "+1 PM": "não precisa tocar a criatura ou inscrição",
      },
      {
        "+2 PM": "em vez do efeito normal, pode conversar com criaturas mortas, desde que esteja próximo ao túmulo ou cadáver. O conhecimento das criaturas mortas é limitado ao que sabiam enquanto vivas e suas respostas são curtas e enigmáticas",
      },
      {
        "+4 PM": "em vez do efeito normal, pode falar e escrever em qualquer idioma",
      },
    ],
  },
  {
    ...
    desc:
      "Você cria uma cortina de faíscas elétricas e redemoinhos, com até 9m de altura e largura, na intersecção entre quadrados. Ela impede a passagem de criaturas voadoras de tamanho Mínimo ou menor e projéteis físicos disparados por criaturas de tamanho Grande ou menor. Atravessar a barreira provoca 1d8 pontos de dano de eletricidade, mas apenas uma vez por rodada para a mesma criatura.",
    bonus: [
      {
        "+1 PM": "aumenta a cortina em +3m na largura ou altura",
      },
      {
        "+2 PM": "aumenta o dano em +1d8",
      },
      {
        "+5 PM": "aumenta as categorias de tamanho afetadas em um passo",
      },
    ],
  },
  {
    ...
    desc:
      "Suas palavras são encantadoras. Ao fazer testes de Atuação, Diplomacia ou Obter Informação, o alvo pode rolar o dado duas vezes e ficar com o melhor resultado",
    bonus: [
      {
        "+1 PM": "também recebe +10 em testes de Enganação para blefar",
      },
      {
        "+2 PM": "o alvo também pode rolar o dado duas vezes e ficar com o melhor resultado ao fazer testes de Enganação",
      },
    ],
  },
];
