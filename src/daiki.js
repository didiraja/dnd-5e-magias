  ...
  talents: [
    {
      ...
      desc: " Você tem uma imensa força de vontade. Benefício: seu bônus de Vontade aumenta em +2. Especial: você pode escolher este talento diversas vezes. Seus efeitos se acumulam",
    }
  ],
  jutsus: [
    {
